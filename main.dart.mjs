...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1314: (x0,x1) => x0.removeItem(x1),
      _1315: (x0,x1,x2) => x0.setItem(x1,x2),
      _1316: Date.now,
      ...
      _1353: Object.is,
      _1354: o => o instanceof Array,
      _1355: (a, i) => a.push(i),
      _1359: a => a.pop(),
      _1360: (a, i) => a.splice(i, 1),
      _1361: (a, s) => a.join(s),
      _1362: (a, s, e) => a.slice(s, e),
      _1364: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1365: a => a.length,
      _1367: (a, i) => a[i],
      _1368: (a, i, v) => a[i] = v,
      _1370: o => {
      ...
      _1371: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1373: o => o instanceof Uint8Array,
      _1374: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1375: o => o instanceof Int8Array,
      _1376: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1377: o => o instanceof Uint8ClampedArray,
      _1378: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1379: o => o instanceof Uint16Array,
      _1380: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1381: o => o instanceof Int16Array,
      _1382: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1383: o => o instanceof Uint32Array,
      _1384: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1385: o => o instanceof Int32Array,
      _1386: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1388: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1389: o => o instanceof Float32Array,
      _1390: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1391: o => o instanceof Float64Array,
      _1392: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1393: (t, s) => t.set(s),
      _1394: l => new DataView(new ArrayBuffer(l)),
      _1395: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1397: o => o.buffer,
      _1398: o => o.byteOffset,
      _1399: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1400: (b, o) => new DataView(b, o),
      _1401: (b, o, l) => new DataView(b, o, l),
      _1402: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1403: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1404: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1405: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1406: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1407: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1408: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1409: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1410: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1411: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1412: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1413: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1416: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1417: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1418: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1419: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1420: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1421: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1434: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1435: (handle) => clearTimeout(handle),
      _1436: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1437: (handle) => clearInterval(handle),
      _1438: (c) =>
      queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
      _1439: () => Date.now(),
      _1444: o => Object.keys(o),
      _1445: (x0,x1) => new WebSocket(x0,x1),
      _1446: (x0,x1) => x0.send(x1),
      _1447: (x0,x1,x2) => x0.close(x1,x2),
      _1448: (x0,x1) => x0.close(x1),
      _1449: x0 => x0.close(),
      ...
      _1468: (x0,x1) => x0.readAsArrayBuffer(x1),
      _1472: x0 => new BroadcastChannel(x0),
      _1473: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1473(f,arguments.length,x0) }),
      _1474: (x0,x1) => x0.postMessage(x1),
      _1475: x0 => x0.close(),
      ...
      _1486: (x0,x1) => x0.key(x1),
      _1487: (x0,x1) => x0.item(x1),
      _1490: (x0,x1) => x0.getContext(x1),
      _1496: (s, m) => {
        try {
      ...
      _1754: (x0,x1) => { x0.oncancel = x1 },
      _1760: (x0,x1) => { x0.onchange = x1 },
      _1800: (x0,x1) => { x0.onerror = x1 },
      _2173: (x0,x1) => { x0.src = x1 },
      _2184: x0 => x0.width,
      _2186: x0 => x0.height,
      _2670: (x0,x1) => { x0.accept = x1 },
      _2684: x0 => x0.files,
      _2710: (x0,x1) => { x0.multiple = x1 },
      _2728: (x0,x1) => { x0.type = x1 },
      _3022: x0 => x0.width,
      _3023: (x0,x1) => { x0.width = x1 },
      _3024: x0 => x0.height,
      _3025: (x0,x1) => { x0.height = x1 },
      ...
      _3898: x0 => x0.vendor,
      _3948: x0 => x0.data,
      _3995: (x0,x1) => { x0.onmessage = x1 },
      _4102: x0 => x0.length,
      _4319: x0 => x0.readyState,
      _4332: (x0,x1) => { x0.binaryType = x1 },
      _4335: x0 => x0.code,
      _4336: x0 => x0.reason,
      _6003: x0 => x0.type,
      _6004: x0 => x0.target,
      _6044: x0 => x0.signal,
      _6116: () => globalThis.document,
      _6198: x0 => x0.body,
      ...
      _8058: x0 => x0.type,
      _8065: x0 => x0.name,
      _8066: x0 => x0.lastModified,
      _8071: x0 => x0.length,
      _8077: x0 => x0.result,
      _8574: x0 => x0.url,
      _8576: x0 => x0.status,
      _8578: x0 => x0.statusText,
      _8579: x0 => x0.headers,
      _8580: x0 => x0.body,
      _12208: x0 => x0.name,
